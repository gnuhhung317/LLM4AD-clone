...
task_description = "The task involves finding optimal routes for a fleet of vehicles to serve a set of customers, respecting time windows and vehicle capacity constraints. Help me design an algorithm to select the next node in each step. This is a 3-objective optimization problem focusing on distance, violations, and execution time."
